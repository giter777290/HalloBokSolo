    ...
    return (
      <div className="ekran items-center justify-center px-6 text-center">
        <p className="text-3xl font-semibold tracking-tight">
          {popravak ? "Nema više grešaka" : "Gotovo za danas"}
        </p>
      ...
      <div className="mx-auto flex w-full max-w-md min-h-0 flex-1 flex-col justify-center
        ...
        {otkriveno && (
          <div className={`mt-6 rounded-2xl p-5 ${
            ...
            {ocjena === "skoro" && (
              <p className="mb-2 text-sm font-medium text-akzent">Skoro — pazite na pisanje.</p>
            )}
            {ocjena === "netocno" && (
      ...
      <div className="mx-auto w-full max-w-md md:max-w-2xl">
        ...
        {otkriveno && vrsta === "otkrivanje" && (
          <div className="grid grid-cols-2 gap-3">
            ...
            <button onClick={() => dalje(true)} className="knopf-voll w-full">Znam</button>
          </div>
        )}
        {otkriveno && vrsta !== "otkrivanje" && (
